...
- The second one is the `callback()` function that will be automatically executed when the “connection” event occurs. In our case, this function simply prints out when a user successfully connects to our backend.
