...
For the first challenge, use your own images this time. Find two images online or on your phone and store them in the same folder as the Python file.

**Note:** Make sure the images have the same width and height. 💡

For the next challenge, try to create a GIF using 3+ images instead of just two! Where do you think the code needs to change?
...
- Try to use your own images this time!
