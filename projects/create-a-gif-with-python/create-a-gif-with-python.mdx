...
You can quickly check if `imageio` package was successfully installed, by opening **Python IDLE** and then running the command `import imageio`. If no errors appear, then you are good to go!
