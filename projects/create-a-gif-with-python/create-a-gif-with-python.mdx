...
In the terminal, navigate to the folder with the Python file using `cd` (change directory). For example, if your file and images are in the **Desktop** folder, you can do:
