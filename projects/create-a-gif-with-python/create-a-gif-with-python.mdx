...
Let’s run this program and see what happens! In VS Code, you can click the play button. If you are doing it in the terminal, run:

```
python3 create_gif.py
```

A new **team.gif** should appear:
