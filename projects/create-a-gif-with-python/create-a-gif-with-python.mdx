...
**Note:** Make sure to store the image files in the same folder as your Python program file. And if you are using your own images, make sure they have the same width and height. 💡
