...
Suppose you have Python and [pip](https://pip.pypa.io/en/stable) the package installer on your computer ([go through this project](https://www.codedex.io/projects/set-up-your-local-environment-in-python) if you don't). In that case, you can install `imageio` using this command in the **Terminal** (Mac) or **Command Prompt** (Windows):
...
In VS Code, you can click the play button. If you are doing it in the terminal, run `python3` and the file name:
