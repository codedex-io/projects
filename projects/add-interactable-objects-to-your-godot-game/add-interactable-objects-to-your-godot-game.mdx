...
Have you ever wondered how interacting with an object in a game triggers something to happen? Like opening a treasure chest, picking up a key, or unlocking a door? Or how an enemy dropping dead right next to you causes their loot to magically appear in your inventory?
...
Your project is now ready! Click "2D" at the top center of the editor, as we'll be creating a two-dimensional game scene in this tutorial. You should see a screen similar to this:
...
Now we have all the groundwork set up, your file manager in the bottom left should be looking something like this:
