...
The code language is called **GDScript**. It is Godot's built-in scripting language and is designed for game dev in the Godot Engine. 

It has a Python-like syntax, but it's not Python! 
