...
A popup menu will appear. We recommend selecting "Compatibility" in the Renderer option, as it provides the most consistent experience across different systems. Then click "Create":
