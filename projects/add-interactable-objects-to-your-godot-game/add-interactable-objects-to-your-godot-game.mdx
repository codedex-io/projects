...
Have you ever wondered how interacting with an object in a game triggers something to happen? Like how opening a treasure chest, picking up a key, or unlocking a door? Or how an enemy dropping dead right next to you causes their loot to magically appear in your inventory?
...
<ImageZoom src="https://raw.githubusercontent.com/codedex-io/projects/refs/heads/main/projects/add-interactable-objects-to-your-godot-game/assets/godot-logo.png" style={{ width: "20%", height: "auto" }} alt="Godot logo" />
...
Your project is now ready! Click "2D" at the top center of the editor, as we'll be creating a two-dimensional game in this tutorial. You should see a screen similar to this:
...
Name this folder **assets**, then copy all the files from the Google Drive folder you downloaded earlier into it. This is where we'll store all of our game artwork. 🖼️
...
1. Click on the "Project" tab in the top bar, and select "Project Settings".
