...
published: live
description: Learn to build a browser-based pixel art maker using HTML Canvas, 2D arrays, and vanilla JavaScript. Draw, erase, flood fill, and export your pixel art as PNG.
