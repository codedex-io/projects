...
header: https://raw.githubusercontent.com/codedex-io/projects/main/projects/build-a-flappy-bird-clone-with-phaser/meta.png
tags:
  - html
  - js
  - intermediate
...
<BannerImage
  link="https://raw.githubusercontent.com/codedex-io/projects/main/projects/build-a-flappy-bird-clone-with-phaser/header.png"
...
<BannerImage link="https://raw.githubusercontent.com/codedex-io/projects/main/projects/build-a-flappy-bird-clone-with-phaser/header.png" description="Title Image" />
...
In this tutorial, we'll learn how to build a clone of the popular mobile game [Flappy Bird](https://en.wikipedia.org/wiki/Flappy_Bird). This will be done with [Phaser](https://phaser.io), a game development framework for creating video games with HTML and JavaScript. We'll also provide a breakdown of each line of code for those who want to get a deeper understanding of how it all works.
...
Congratulations! We've reached the end of the tutorial, and you have built a functional clone of the popular mobile game Flappy Bird! We harnessed the power of Phaser to build this game with just HTML and JavaScript. Additionally, we got to learn a bit about how game elements are used and placed on a browser screen.

The full code for this project can be viewed [here](https://github.com/codedex-io/projects/tree/main/projects/build-a-flappy-bird-clone-with-phaser).
