...
In this project tutorial, we'll learn how to build a clone of the popular mobile game [Flappy Bird](https://en.wikipedia.org/wiki/Flappy_Bird). 

This will be done with [Phaser](https://phaser.io), a game development framework for creating video games with HTML and JavaScript (JS). We'll also provide a breakdown of each line of code for those who want to get a deeper understanding of how it all works.
...
<img
  ...
  alt="Finished Flappy Bird Clone"
/>
...
<img
  ...
  alt="Rendered Flappy Bird App - Background Only"
/>
...
<img
  ...
  alt="Rendered Background and Road"
/>
...
<img
  ...
  alt="Rendered Bird Falling Through Road"
/>
...
<img
  ...
  alt="Rendered Bird Moving Right"
/>
...
<img
  ...
  alt="Instructions Rendered In Top-Left Corner"
/>
...
<img
  ...
  alt="Instructions Centere-Aligned Towards Bottom Of Screen"
/>
