...
<BannerImage link="" description="Title Image" />
...
Next, let's add lthe following code above the functions we defined:
...
If you save the files and double-click **index.html**, the following should render on the browser:
...
In repeat, we specify that we want to create two columns at once.
