...
Also, since Valorant appeared as both "VALORANT" and "Valorant", let's just make sure it's not wayyy higher:

```sql
SELECT most_streamed_game, COUNT(*)
FROM streamers2024
WHERE most_streamed_game = 'VALORANT' or most_streamed_game = 'Valorant';
```
