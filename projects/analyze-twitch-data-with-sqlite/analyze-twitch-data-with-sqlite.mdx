...
## Grouping Top Into Genres in 2024

So earlier, we found out the most popular games in 2024. Let's do it with a `LIMIT 25` this time:
...
- Survival
- MMORPG: [Massively Multiplyaer Online Role-Playing Game](https://en.wikipedia.org/wiki/Massively_multiplayer_online_role-playing_game)
- Gambling
...
Using `CASE`, your logic should be: 
  ...
  - If Dota 2 → MOBA 
  - If Counter-Strike → FPS 
  - If Minecraft → Survival 
  - Else → Other 
...
SELECT
  CASE
    ...
    WHEN most_streamed_game = 'League of Legends' OR most_streamed_game = 'Dota 2'
      THEN 'MOBA'
    WHEN most_streamed_game = 'VALORANT' OR most_streamed_game = 'Valorant' OR most_streamed_game = 'Counter-Strike'
      THEN 'FPS'
    WHEN most_streamed_game = 'Overwatch'
      THEN 'FPS'
    WHEN most_streamed_game = 'Escape from Tarkov'
      THEN 'FPS'
    WHEN most_streamed_game = 'Minecraft'
      THEN 'Survival'
    WHEN most_streamed_game = 'Fortnite'
      THEN 'Battle Royale'
    WHEN most_streamed_game = 'Apex Legends'
      THEN 'Battle Royale'
    WHEN most_streamed_game = 'Call of Duty: Warzone'
      THEN 'Battle Royale'
    WHEN most_streamed_game = 'PUBG: BATTLEGROUNDS'
      THEN 'Battle Royale'
    ...
    WHEN most_streamed_game = 'Casino' OR most_streamed_game = 'Virtual Casino' OR most_streamed_game = 'Slots'
      THEN 'Gambling'
    WHEN most_streamed_game = 'Sports' OR most_streamed_game = 'FIFA 23'
      THEN 'Sports'
  ELSE 'Other'
  END AS 'genre',
  COUNT(*)
