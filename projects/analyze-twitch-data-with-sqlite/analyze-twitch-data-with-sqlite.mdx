...
First, install SQLite if you don't have it. Check out our [Setting Up SQLite Locally](https://www.codedex.io/sql/bonus/sqlite) bonus article if you need help.
