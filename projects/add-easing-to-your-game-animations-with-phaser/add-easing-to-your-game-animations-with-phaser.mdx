...
<ImageZoom
  src="https://raw.githubusercontent.com/codedex-io/projects/tree/main/projects/add-easing-to-your-game-animations-with-phaser/assets/redGreen.gif"
...
```jsx
function preload() {
  this.load.spritesheet("player", "https://i.imgur.com/jT8aRa1.png", {
    frameWidth: 120,
    frameHeight: 120
  });
}
