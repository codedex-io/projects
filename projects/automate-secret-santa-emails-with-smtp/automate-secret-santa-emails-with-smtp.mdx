...
header: https://raw.githubusercontent.com/codedex-io/projects/main/projects/automate-secret-santa-emails-with-smtp/header.jpg
tags:
  - python
  - intermediate
---
...
Christmas is a time of giving and expressing gratitude; you know what that means: present exchanges! 🎁 However, Codédex has started doing the [Secret Santa](https://en.wikipedia.org/wiki/Secret_Santa) tradition to lessen the awkwardness: everyone anonymously buys a present for a random person on the team! This is the way everyone exchanges presents without all the awkwardness.
...
## [#](#-secret-santa-rules) Secret Santa Rules

Here are the basic rules of Secret Santa:

- Each person draws a random person to send a present to.
- Everyone must draw another person and not themselves.
- Once all the draws are decided, everyone will buy a present for the person that they've drawn.
...
> The [Simple Mail Transfer Protocol](https://en.wikipedia.org/wiki/Simple_Mail_Transfer_Protocol) (SMTP) is an Internet standard communication protocol for email transmission designed in 1980. Mail servers and other message transfer agents use SMTP to send and receive mail messages.
...
To install these libraries, run the following in your terminal:
...
## [#](#-automating-secret-santa) Automating Secret Santa
...
## [#](#-automating-secret-santa) Final Code
