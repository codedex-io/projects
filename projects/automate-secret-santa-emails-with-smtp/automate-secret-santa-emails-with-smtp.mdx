...
Christmas is a time of giving and expressing gratitude; you know what that means: present exchanges! 🎁 
...
Here's the basic process of Secret Santa:

- Each person will be assigned another random person via email.
- Once everyone is assigned a person, they will buy a gift for that person (<$20).
