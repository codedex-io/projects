...
Christmas is a time of giving, and expressing our gratitude, and you know what that means: present exchanges! 🎁 However, Codédex has started doing the [Secret Santa](https://en.wikipedia.org/wiki/Secret_Santa) tradition to lessen the awkwardness: everyone buys a present for a random person in the team anonymously! This is way everyone exchanges presents without all the awkwardness.
