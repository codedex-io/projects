...
Christmas is a time of giving and expressing gratitude; you know what that means: present exchanges! 🎁 Codédex has started doing the [Secret Santa](https://en.wikipedia.org/wiki/Secret_Santa) tradition to lessen the awkwardness: everyone anonymously buys a present for a random person on the team! This way everyone can exchange presents without all the awkwardness.
...
- Each person will be assigned a random person via email.
