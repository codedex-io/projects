...
Jump into your favorite code editor (VS Code is my personal choice), and search for the live server extension. Install it and relaunch the editor. You should see the “Go Live” option in the bottom right corner of your editor.
