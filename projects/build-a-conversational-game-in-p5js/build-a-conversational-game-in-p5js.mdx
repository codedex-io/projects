...
The game is called _A Conversation_, and it’s a two-player game of Pong, but with a twist. Instead of each paddle, I drew a person’s head facing toward the center, and instead of a ball, I drew a speech bubble. As players hit the speech bubble back and forth, the text inside the speech bubble changes to form a conversation.
...
<RoundedImage link="https://i.imgur.com/f8m1zfQ.jpeg" description="" />
...
<RoundedImage link="https://i.imgur.com/XyJaet1.png" description="" />
...
<RoundedImage link="https://i.imgur.com/qKVVVtZ.png" description="" />
...
<RoundedImage link="https://i.imgur.com/4r8RZbT.gif" description="literally" />
...
<RoundedImage link="https://i.imgur.com/leVbTL9.gif" description="" />
