...
Can you guess what was the first commercially successful video game ever created? It was called Pong!

[Pong](https://en.wikipedia.org/wiki/Pong) is a simple 2D table tennis arcade game created by Atari in 1972. With today's technology, it's super easy to make!

In this tutorial, you'll learn how to recreate Pong using Python and the PyGame library. You will learn how this game engine works and how you can make simple collision detection so you and a friend can play Pong on the same computer!
