...
After you've created your account with OpenAI, you can click on your profile picture on the top right, then click **View API keys** to get access to your API key. You can also click the following link to go directly to the page: https://beta.openai.com/account/api-keys.
