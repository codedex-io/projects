...
openai.api_key = 'sk-jAjqdWoqZLGsh7nXf5i8T3BlbkFJ9CYRkMSvNP' # Fill in your own key
```
...
And boom, after 1-3 seconds, it should spit out a paragraph like this:

```bash
There are a few reasons why New York City is better than other cities. First, NYC is more diverse than any other city in the world. You can find people from all walks of life here, and the city is always buzzing with energy. Second, the food in NYC is some of the best in the world. You can find any type of cuisine you're in the mood for, and the quality is always top-notch. Finally, the city is just plain fun. There's always something to do, whether you're into art, music, or just exploring.
```
...
If you have been playing with the API nonstop, you might have exceeded the $18 limit. The following error is thrown when that happens:
