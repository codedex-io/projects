...
After you've created an account, click on your profile picture on the top right, then click "View API keys" to access your API key. 

You should see [this page](https://beta.openai.com/account/api-keys) and it should look like:
...
With this API key, we get access to GPT-3 and \$18 worth of free credit. Meaning that we can use GPT-3 for free until we have used up the \$18, which is more than enough to complete this project.
...
openai.api_key = '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' # Fill in your own key
```
