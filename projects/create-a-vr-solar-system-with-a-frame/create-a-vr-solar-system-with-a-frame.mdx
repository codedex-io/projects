...
# Build the Solar System With A-Frame
...
Under the same directory as your **index.html** file, create a new **planet_textures/** folder. Next, you can find the texture files for our system [here](https://raw.githubusercontent.com/codedex-io/projects/main/projects/create-a-vr-solar-system-with-a-frame/planet_textures). Go ahead and download each file and add them to your **planet_textures/** folder.
...
```html
<a-sphere id="mercury" position="3.9 1.25 -5" radius="0.1" src="planet_textures/mercury.jpeg" rotation="0 0 0" animation="property: rotate; to: 0 360 0; loop: true; dur: 58650"></a-sphere>
```
...
- [Source code for this project](https://github.com/codedex-io/projects/tree/main/projects/create-a-vr-solar-system-with-a-frame)
