...
At Codédex, we built an online code editor just for you. With no setup required, you can code to your heart’s desire. However, there is a small issue: your code is in the cloud and requires the internet to run! Without WiFi, you can no longer code! This may hinder your progress toward "The Legend of Python"! 
