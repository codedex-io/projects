...
Running a program locally means using the resources of the computer that you’re currently using to execute a program. Therefore, a local environment is just a simple setup to get your computer ready to be able to run a program.  
