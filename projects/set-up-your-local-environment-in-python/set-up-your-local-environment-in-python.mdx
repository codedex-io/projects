...
- On the bottom, you can see a command line, which is used to see outputs, access files, and more. You can use either a Windows command prompt or a Linux terminal! 
...
Some examples include <kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>↓</kbd> or <kbd>CTRL</kbd> + <kbd>D</kbd>!
