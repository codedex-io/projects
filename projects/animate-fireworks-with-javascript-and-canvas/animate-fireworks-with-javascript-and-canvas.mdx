...
<AuthorAvatar author_name="Olga Ivanova" author_avatar="/images/projects/authors/olga_ivanova.png" />

<BannerImage link="https://raw.githubusercontent.com/codedex-io/projects/main/projects/animate-fireworks-with-javascript-and-canvas/header.png" description="Header image" />
...
Jump into your favorite code editor ([VS Code](https://code.visualstudio.com/) is my personal choice), and search for the "Live Server" extension:
