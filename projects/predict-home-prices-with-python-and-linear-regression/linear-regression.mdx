...
In this tutorial, we will be using a [data set](https://docs.google.com/spreadsheets/d/11IDKeCPA5jMSG5I_KNps4VfFVfNyG8eIizwnm7KLR4o/edit#gid=0) that compares house size and house prices of properties sold in Brooklyn's Dumbo neighborhood to predict the cost of houses based on size. 
...
Take what you learned an extra step, let’s gather some data and use linear regression to visualize it. [Kaggle](https://www.kaggle.com/) is a great place to find data sets that have already been proven but you can also import any data. Get creative and remember to format your data for easy access.
