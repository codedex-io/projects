...
Before we get started, you will need a few things if you don't have it already.

### [##](##-set-up-python-coding-environment) Set Up Python Coding Environment

1. Install [Python 3](https://www.python.org/downloads/).
2. Install [pip](https://pip.pypa.io/en/stable/installation/) the package installer.

### [##](##-set-up-discord-account) Set Up Discord Account

1. Have a Discord account.
2. Make sure you have a Discord server with "Manager Server" permissions.
...
To let Discord know we're going to be connecting to their backend servers, we need to register an application and set up the required permissions. Click "New Application" on the top right.
...
### [##](##-invite-your-application-to-your-discord-server) Step 5. Invite Application to Your Discord Server
...
- **Solution Code**: [bot.py](https://github.com/codedex-io/projects/blob/main/projects/build-a-discord-bot-with-python/bot.py)
